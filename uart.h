...
*
* Modified for AVR-GCC compiler and ATtiny25, GRA 2009
*
****************************************************************************/
...
extern void uart_fFlushBuffers( void );
extern void uart_fInitReceiver( void );
extern void uart_fTransmitByte( uint8 );
extern bool uart_fGetMessage(uint8 *);
extern void uart_fSendMsg(char *);
extern void uart_fSendFlashMsg(char *);
extern void uart_fSendEepromMsg(uint8 *);
